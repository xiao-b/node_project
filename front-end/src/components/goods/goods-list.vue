...
<script>
    ...
    export default {
        ...
        methods: {
            // 删除
            handleDelete(row) {
                this.func.ajaxPost(/* this.api.goodsDelete */'http://localhost:9999/api/goods/list', {id: row.id}, res => {
        ...
        created () {
            ...
            this.func.ajaxGet(/* this.api.goodsList */'http://localhost:9999/api/goods/list', res => {
